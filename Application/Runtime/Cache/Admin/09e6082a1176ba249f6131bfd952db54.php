					...
					<div class="portlet light">
						<div class="portlet-title">
							...
							<div style="margin-left:8px;margin-top:8px;float:left;" class="btn-group">
								...
								<button data-toggle="dropdown" class="btn btn-sm default dropdown-toggle" type="button"><i class="fa fa-angle-down"></i></button>
								<div role="menu" class="dropdown-menu hold-on-click dropdown-checkboxes">
									<label><div class="checker"><span class="checked"><input type="checkbox" checked=""></span></div>一月</label>
									<label><div class="checker"><span class="checked"><input type="checkbox" checked=""></span></div>二月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>三月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>四月</label>
									<label><div class="checker"><span><input type="checkbox" checked=""></span></div>五月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>六月</label>
									<label><div class="checker"><span><input type="checkbox" checked=""></span></div>七月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>八月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>九月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>十月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>十一月</label>
									<label><div class="checker"><span ><input type="checkbox" checked=""></span></div>十二月</label>
								</div>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
