...
<link href="/Public/Style/assets/global/plugins/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" type="text/css"/>
<!-- END DATE PAGINATOR PLUGIN -->

<!-- BEGIN PAGE LEVEL STYLES USE FOR SLIDER -->
<link href="/Public/Style/assets/global/plugins/ion.rangeslider/css/ion.rangeSlider.css" rel="stylesheet" type="text/css"/>
<link href="/Public/Style/assets/global/plugins/ion.rangeslider/css/ion.rangeSlider.Metronic.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE LEVEL STYLES -->
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="/Public/Style/assets/admin/layout2/img/logo-default.png" alt="logo" style="width: 94px; height: 16px;" class="logo-default"/>
			</a>
		...
		<div class="page-top">
			...
			<form class="search-form search-form-expanded" action="extra_search.html" method="GET">
				<div class="input-group">
					<input type="text" class="form-control" placeholder="输入搜索内容..." name="query">
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle hide1" src="/Public/Style/assets/admin/layout2/img/avatar4.jpg"/>
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
					...
					<div class="modal-dialog">
						<div class="modal-content">
										...
										<div class="col-md-9">
											<div class="input-inline input-medium">
												<div class="input-group">
													...
													<input type="email" autocomplete="off" id="old_password" name="old_password" class="form-control" placeholder="旧密码">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-md-9">
												<div class="input-inline input-medium">
													<div class="input-group">
														...
														<input type="password" autocomplete="off"  id="new_password" name="new_password" class="form-control" placeholder="新密码">
											...
											<div class="col-md-9">
												<div class="input-inline input-medium">
													<div class="input-group">
														...
														<input type="password" autocomplete="off"  id="new_repassword" name="new_repassword" class="form-control" placeholder="密码确认">
							...
							<div class="modal-footer">
								<button type="button" class="btn green" id="modify_password">提交</button>
										...
										<div class="col-md-9">
											<div class="input-inline input-medium">
												<div class="input-group">
													...
													<input type="email" autocomplete="off" id="wifi_account" name="wifi_account" class="form-control" placeholder="WIFI帐号">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-md-9">
												<div class="input-inline input-medium">
													<div class="input-group">
														...
														<input type="password" autocomplete="off"  id="wifi_password" name="wifi_password" class="form-control" placeholder="WIFI密码">
														...
														<div class="col-md-9">
															<div class="input-inline input-medium">
																<div class="input-group">
																	...
																	<input type="text" id="wifi_account_step" autocomplete="off"  name="wifi_account" class="form-control" placeholder="输入WIFI帐号">
																</div>
															</div>
														</div>
													</div>
															...
															<div class="col-md-9">
																<div class="input-inline input-medium">
																	<div class="input-group">
																		...
																		<input type="password" id="wifi_password_step" autocomplete="off"  name="wifi_password" class="form-control" placeholder="输入WIFI密码">
				...
				<div class="page-bar">
					...
					<div class="page-toolbar">
						<div class="btn-group pull-right">
							...
							<div class="btn-group btn-group-solid page-breadcrumb">
									<a href="/index.php/Admin/camera/lists/display_type/lists" title="列表显示"><button type="button" class="btn btn-xs <?php echo $display_type=='lists'?'green':'grey-salsa';?>"><i class="fa fa-list-ul"></i> </button></a>
									<a href="/index.php/Admin/camera/lists/display_type/block_lists" title="分块显示"><button type="button" class="btn btn-xs <?php echo $display_type!='lists'?'green':'grey-salsa';?>"><i class="fa fa-th-large"></i> </button></a>
							</div>
							...
							<ul class="dropdown-menu pull-right" role="menu">
								<li>
									<a href="/index.php/Admin/camera/lists/display_type/lists">列表显示</a>
								</li>
								<li>
									<a href="/index.php/Admin/camera/lists/display_type/block_lists">块级显示</a>
								</li>
				...
				<!-- END PAGE HEADER-->
				<!-- BEGIN PAGE CONTENT-->
				<?php if($display_type == 'lists' ): ?><!-- 列表显示方式 -->
				<div class="row">
					<div class="col-md-12">
    	...
    	<?php else: ?><!-- 摄像头块级显示 --> 
    		<div class="clearfix">
				...
				<div class="row">
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-6 col-sm-6">
						<!-- BEGIN PORTLET-->
						<div class="portlet light ">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-video-camera font-green-sharp"></i>
									<span class="caption-subject <?php if(($vo["status"] == 't')): ?>font-green-sharp<?php else: ?> font-red-sunglo<?php endif; ?> bold uppercase"><?php echo ($vo["equipmentName"]); ?></span>
									<!--  <span class="caption-helper">weekly stats...</span>-->
									<?php if(($vo["status"] == 't')): ?><!-- <span style="float:left;" class="label label-sm label-success">监控中 </span>-->
										<span class="caption-helper">监控中...</span>
									<?php else: ?> 
										<span class="caption-helper">未连接...</span><?php endif; ?>
								</div>
								<div class="actions">
									
									<div class="btn-group btn-group-devided" data-toggle="buttons">
										<a href="#stack1" id="btn_play_rtmp_<?php echo ($vo["SN"]); ?>" data-toggle="modal" class="btn btn-circle btn-sm purple">
																<i class="fa fa-history"></i> 回放 </a>
										<div style="float:left;">
											<a href="#" class="btn btn-circle btn-sm green-haze dropdown-toggle" data-toggle="dropdown">
																控制 <i class="fa fa-cogs"></i></a>
											<!--  <button type="button" class="btn btn-sm green-haze dropdown-toggle" data-toggle="dropdown">控制</button>
											<button type="button" class="btn btn-sm btn-circle-right green-haze dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cogs"></i></button>-->
							...
							<div class="portlet-body text-center">
								<div id="play_block_<?php echo ($vo["SN"]); ?>">
									<div id="site_statistics_loading">
										<img src="/Public/Style/assets/admin/layout2/img/loading.gif" alt="loading"/>
									</div>
								</div>
							</div>
						<!-- END PORTLET-->
...
<!-- <script type="text/javascript" src="/Public/Style/assets/global/plugins/datatables/media/js/jquery.dataTables.min.js"></script>-->
...
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script type="text/javascript" src="/Public/Style/assets/global/plugins/jquery-validation/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="/Public/Style/assets/global/plugins/jquery-validation/js/additional-methods.min.js"></script>
<script type="text/javascript" src="/Public/Style/assets/global/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->


<!-- BEGIN DATE PAGINATOR PLUGIN -->
<!--  <script src="/Public/Style/assets/global/plugins/moment.min.js" type="text/javascript"></script>-->
<script src="/Public/Style/assets/global/plugins/moment-with-locales.js" type="text/javascript"></script>
<script src="/Public/Style/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
<script src="/Public/Style/assets/global/plugins/bootstrap-datepaginator/bootstrap-datepaginator.js" type="text/javascript"></script>
<!-- END DATE PAGINATOR PLUGIN -->

<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="/Public/Style/assets/global/plugins/ion.rangeslider/js/ion-rangeSlider/ion.rangeSlider.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
...
<script src="/Public/Style/assets/admin/pages/scripts/form-wizard.js"></script>
...
-->
<script type="text/javascript" src="/Public/Style/assets/global/plugins/jwplayer/jwplayer.js" ></script>
...
<!-- jquery qrcode start-->
<script type="text/javascript" src="/Public/Style/assets/global/plugins/jquery-qrcode/jquery.qrcode.js"></script>
<script type="text/javascript" src="/Public/Style/assets/global/plugins/jquery-qrcode/qrcode.js"></script>
<!-- jquery qrcode end-->
...
var login_username = "<?php echo $_SESSION['user']['username'];?>";
var login_password = "<?php echo $_SESSION['user']['password'];?>";
var srs_ip = '<?php echo ($srs["IP"]); ?>';
var srs_port = '<?php echo ($srs["stm_port"]); ?>';
var srs_http_port = '<?php echo ($srs["ply_port"]); ?>';
var current_play_camera_sn = '';
...
function dragPlay(msecond,flag){
	...
	if(flag=='online'){
		var path='live';
		url = 'rtmp://'+srs_ip+':'+srs_port+'/'+path+'/'+current_play_camera_sn+"?username="+login_username+"&password="+login_password;
	}else{
		url = "http://"+srs_ip+":"+srs_http_port+"/live/"+current_play_camera_sn+"."+timestamp+".flv?username="+login_username+"&password="+login_password;
	}
...
jQuery(document).ready(function() {
	...
	//var url = 'rtmp://'+{}+':'+camera_srsport+'/'+path+'/'+camera_sn+"?username="+login_username+"&password="+login_password;
	var url = '';
	
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>camera_sn = '<?php echo ($vo["SN"]); ?>';
	url = 'rtmp://'+'<?php echo ($srs["IP"]); ?>'+':'+'<?php echo ($srs["stm_port"]); ?>'+'/'+srs_path+'/'+camera_sn+"?username="+login_username+"&password="+login_password;
	 ...
	 $("#video_ctl_"+camera_sn).bind("click",{camera_sn:camera_sn},function(event){
		 ...
		 //alert(cmd);
		 $.ajax({
				url : "/index.php/Admin/camera/camera_ctl",
				type : "POST",
				cache : false,
				async : true,
				dataType : "json",
	...
	//var url = 'rtmp://'+{}+':'+camera_srsport+'/'+path+'/'+camera_sn+"?username="+login_username+"&password="+login_password;
	$('#btn_play_rtmp_'+camera_sn).bind('click',{url:url,camera_sn:camera_sn},function(event){
		  //设置当前播放的摄像头SN码
		   current_play_camera_sn = event.data.camera_sn;
	   ...
	   <?php if($display_type == 'lists' ): else: ?>
	   var http_url = "http://192.168.2.231:8080/live/test.1414574984000.flv?username=hanhuade&password=123456";
	   	  var conf = {
	           file: http_url,
	           //file:"test.1411296393884.flv?time=12345646",
	           width: 445,
	           ...
	           autostart: false,
	           analytics: { enabled: false},
	           image:"/Public/Style/assets/img/company1.jpg",
	           modes :[  
	                   {type:"html5"}  
	                  ]  
	       };
	       _player = jwplayer('play_block_'+'<?php echo ($vo["SN"]); ?>').setup(conf);<?php endif; endforeach; endif; else: echo "" ;endif; ?>
	...
	//视频播放的时间轴---------
	 ...
	 $('#create_qrcode').on("click",function(){
		 ...
		 if($.cookie("wifi_account") && $.cookie("wifi_password") && login_username && login_password){
			 jQuery('#qrcode_div').html('');
			 jQuery('#qrcode_div').qrcode({
				render	: ($.browser.msie && $.browser.version < 9 ? "table" : "canvas"),
				text	: $.cookie("wifi_account")+','+$.cookie("wifi_password")+','+login_username+','+login_password,
				width       : 128,     //设置宽度  
				height      : 128
			});
	 ...
	 $('#modify_password').on("click",function(){
		 ...
		 if(new_repassword != new_password){
			 alert('两次输入密码不一致！'+new_password+'-'+new_repassword);
			 return false;
		 }
		 $.ajax({
