	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>对比分析<small>设备统计数据对比分析</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div>
						...
						<div class="pull-left" style="margin-top:8px">选择条件：</div>
							
							<div class="btn-group pull-left">
								<button type="button" class="btn default">A设备</button>
								<button type="button" class="btn default dropdown-toggle" data-toggle="dropdown"><i class="fa fa-angle-down"></i></button>
								<div class="dropdown-menu hold-on-click dropdown-checkboxes" role="menu">
									<label><input type="checkbox" checked>A设备</label>
									<label><input type="checkbox">B设备</label>
									
								</div>
							</div>
							
							<div class="form-group pull-left " >
										<label class="control-label col-md-2" style="padding:0;margin-top: 6px;margin-left: 10px;">时间</label>
								...
								<div class="btn-group pull-left">
								<button type="button" class="btn default">B设备</button>
								<button type="button" class="btn default dropdown-toggle" data-toggle="dropdown"><i class="fa fa-angle-down"></i></button>
								<div class="dropdown-menu hold-on-click dropdown-checkboxes" role="menu">
									<label><input type="checkbox" >A设备</label>
									<label><input type="checkbox" checked>B设备</label>
