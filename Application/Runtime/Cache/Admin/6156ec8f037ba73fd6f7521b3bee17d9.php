	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">
				我的设备 <small>智能摄像头</small>
				</h3>
				<div class="page-bar">
					<ul class="page-breadcrumb">
						<li>
							<i class="fa fa-home"></i>
							<a href="index.html">我的设备</a>
...
function dragPlay(msecond,flag){
	...
	if(flag=='online'){
		var path='live';
		url = 'rtmp://'+srs_ip+':'+srs_port+'/'+path+'/'+current_play_camera_cn+"?username="+login_username+"&password="+login_password;
	}else{
		url = "http://"+srs_ip+":"+srs_http_port+"/live/"+current_play_camera_cn+"."+timestamp+".flv?username="+login_username+"&password="+login_password;
	}
