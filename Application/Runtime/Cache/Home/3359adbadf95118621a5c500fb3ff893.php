    ...
    <div class="header">
      <div class="container">
        ...
        <div class="header-navigation pull-right font-transform-inherit">
	      ...
	      <li><a target="_blank" href="http://camera.cn/index.php/Admin/user/login2">我的设备</a></li>
 ...
 --> 
    ...
    <div class="main" >
      <div class="container">
        ...
        <div class="row margin-bottom-40" style="background:url('/Public/Style/assets/img/xufei.jpg') no-repeat;height:520px;">
          <!-- BEGIN SIDEBAR -->
          <!-- 
          ...
          <div class="col-md-5 col-md-offset-3" style="margin-top: 50px;/*margin-left: 300px;*/">
						<!-- BEGIN SAMPLE FORM PORTLET-->
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-user font-blue-hoki"></i> 输入注册信息
								</div>
							</div>
							<div class="portlet-body">
								<br/>
								<br/>
								<form class="form-horizontal" method="POST" action="/index.php/Admin/user/do_register" role="form" autocomplete="off">
									<div class="form-group">
										<label class="col-md-3 control-label">帐号</label>
										<div class="col-md-7">
											<div class="input-icon">
												<i class="fa fa-user"></i>
												<input type="text" name="userName" class="form-control" placeholder="输入帐号">
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="col-md-offset-2 col-md-10">
											...
											<button type="reset" class="btn grey">重置</button>
										</div>
									</div>
								</form>
								<hr>
...
<!-- BEGIN FOOTER -->
    <div class="footer" style="background: none repeat scroll 0 0 white;">
      <div class="container">
        <div class="row">
          <!-- BEGIN COPYRIGHT -->
          <div class="col-md-12 col-sm-6 padding-top-10" style="text-align: center;">
            <font color="black">2014 © 成都守望者科技有限公司. ALL Rights Reserved.</font>
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
