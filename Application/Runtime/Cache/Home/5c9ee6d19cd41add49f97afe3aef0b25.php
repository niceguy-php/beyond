...
<body class="corporate">
 ...
 --> 
    ...
    <div class="main"  style="background:url('/Public/Style/assets/img/loginbgimg.jpg') no-repeat;height:600px;">
      <div class="container">
        <ul class="breadcrumb">
        ...
        <div class="row margin-bottom-40">
          ...
          <!-- BEGIN CONTENT -->
          <div class="col-md-6 col-sm-9 col-md-offset-6" style="/*margin-left: 600px;margin-top: 50px;*/">
            <div>
              <div class="row">
              ...
              <div class="col-md-10">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-user font-blue-hoki"></i> 输入登录信息
								</div>
							</div>
							<div class="portlet-body">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label for="inputEmail12" class="col-md-3 control-label">帐号</label>
										<div class="col-md-7">
											<div class="input-icon">
												<i class="fa fa-user"></i>
												<input type="email" class="form-control" id="inputEmail12" placeholder="输入帐号">
											</div>
										</div>
									</div>
									<div class="form-group">
                  ...
                  <form class="form-horizontal form-without-legend" role="form">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0">
                        <a href="page-forgotton-password.html">忘记密码?</a>
                      </div>
                    </div>
                    <div class="row">
