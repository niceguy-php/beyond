 ...
 --> 
	...
	<div class="container" >
		<div class="text-center row col-md-12" style="position:relative;">
			<img src="/Public/Style/assets/img/camera.jpg" class="img-responsive"/>
		...
		<div class="text-center">
			<img src="/Public/Style/assets/img/parents.jpg" class="img-responsive"/>
		</div> 
		<div class="text-center">
			<img src="/Public/Style/assets/img/child.jpg" class="img-responsive"/>
		</div>
		<div class="text-center">
			<img src="/Public/Style/assets/img/pet.jpg" class="img-responsive"/>
		</div>
		<!--  
		<div class="col-md-12 col-xs-12" style="height:506px;background:url('/Public/Home/img/index.jpg')"></div>
		<div class="col-md-12 col-xs-12" style="height:606px;background:url('/Public/Home/img/collect_mob.jpg') no-repeat top center"></div>
		<div class="col-md-12 col-xs-12" style="height:606px;background:url('/Public/Home/img/enjoy.jpg') no-repeat top center">
			
			<div style="width:224px;height:167px;float:left;margin-left: 280px;margin-top: 350px;">
				<p style="font-size:16px;color:#464646;">体验和分享</p>
				<p>捕捉精彩瞬间和有趣视频</p>
				<p>分享给家人和朋友</p>
				<p>不错过每一个瞬间</p>
			    <p style="padding-left:50px;background:red;height:30px;">
					<a href="/front/productinfo.html" class="" target="_blank"><font color="white">了解更多</font></a>
				</p>
			</div>
		</div>-->
